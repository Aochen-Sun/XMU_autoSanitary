...
for Room, blockID in zip(aggregate_df['Room'], aggregate_df['blockID']):
    ...
    driver.find_element(by=By.XPATH, value= '//*[@id="app"]/div/div[3]/form/div[3]/div[9]/div/div[2]/div/div[2]/div[1]/input').send_keys(s)
    ...
    driver.find_element(by=By.XPATH, value= '//*[@id="app"]/div/div[3]/form/div[4]/div[2]/div[4]/div[2]/div[1]/textarea').clear() 
